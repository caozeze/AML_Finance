...
# Self Write Wrapper to use the FTTransformer in our code
class FTTransformerWrapper(nn.Module):
    def __init__(self, cat_dims, cat_idxs, num_idxs, num_classes=3, 
                 num_heads=4, num_layers=2, dim_model=64, dim_ff=128, dropout=0.1):
    ...
    def get_attention_weights(self, x):
        ...
        _, attns = self.model(x_categ, x_numer, return_attn=True)
